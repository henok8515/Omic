...
function Left_Nav() {
  return (
    <div className=" justify-between  text-white bg-gray-900  flex flex-col  items-center h-full w-16">
      ...
      <div className="mb-6">
        <Avatar
          src="https://media.istockphoto.com/id/1287598154/photo/passport-photo-of-latin-american-man-with-beard.webp?b=1&s=170667a&w=0&k=20&c=-huleRqnMGpvsOlKm62JvDxd8zWVaJQNxn-YcFuJtaM="
          fontSize="small"
        />
      </div>
    </div>
